...
% This is a LaTeX template for a resume. It is designed to be simple and easy to Customize.
%-------------------------
% Resume in Latex
...
\begin{center}
    ...
    \href{tel:+919082869978}{\underline{+91 9082869978}} $|$ \href{mailto:ramit.t.work@gmail.com}{\underline{ramit.t.work@gmail.com}} $|$ 
...
\vspace{-5pt}
\section*{About Me}
Hi! I'm Ramit Taparia — an aspiring backend developer with a strong foundation in Python and Node.js. Passionate about building scalable APIs and efficient server-side systems. Currently focusing on expanding my knowledge in distributed systems and cloud technologies.
...
\resumeSubHeadingListStart
 \resumeSubheading
    {Product Engineering Intern}{March 2024 -- May 2024}
    {Viskk}{Remote}
    \resumeItemListStart
...
\resumeProjectHeading
    {\textbf{GitHub Pipeline ETL} $|$ \emph{Python, SQLite, Docker}}{June 2026}
    \resumeItemListStart
      \resumeItem{Built an end-to-end ETL pipeline in Python to extract, transform, and load structured data into a SQLite database.}
      \resumeItem{Containerized the application using Docker to ensure consistent execution across different environments.}
      \resumeItem{Implemented data cleaning and transformation logic to process raw data before storage.}
      \resumeItem{Designed a modular project structure separating extraction, transformation, and loading stages for maintainability and scalability.}
    \resumeItemListEnd
  \resumeProjectHeading
      ...
      \resumeItemListEnd
  \resumeProjectHeading
      {\textbf{QRTick - Ticket Creation script} $|$ \emph{Python, MongoDB}}{March 2025}
      \resumeItemListStart
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
        ...
        \textbf{Tools/Platforms:} Git, GitHub, MongoDB, Postman , SQL \\
