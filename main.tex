...
\resumeSubHeadingListStart
  ...
  \resumeProjectHeading
      {\textbf{Short-Url} $|$ \emph{Node.js, Express.js, MongoDB, JWT}}{May 2025}
      \resumeItemListStart
        \resumeItem{Developed a secure URL shortening service using Node.js, Express.js, and MongoDB.}
        \resumeItem{Implemented JWT-based authentication to protect API endpoints.}
        \resumeItem{Designed modular architecture with clear separation of concerns for routing, models, and controllers.}
        \resumeItem{Deployed the project on GitHub: \href{https://github.com/foundRamit/Short-Url}{Short-Url}.}
      \resumeItemListEnd
  \resumeProjectHeading
